...
/***/ (function(module, exports) {
	...
	var IntroCard = function (_React$Component) {
	  ...
	  function IntroCard() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IntroCard.__proto__ || Object.getPrototypeOf(IntroCard)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      initial_likes: 100,
	      initial_dislikes: 25,
	      likes_number: 0,
	      dislikes_number: 0,
	      ...
	      var _this$state = _this.state,
	          hit_like = _this$state.hit_like,
	          hit_dislike = _this$state.hit_dislike,
	          likes_number = _this$state.likes_number,
	          dislikes_number = _this$state.dislikes_number;

	      if (hit_dislike && !hit_like) {
	        _this.setState({ dislikes_number: dislikes_number - 1 });
	        document.getElementById('dislike-button').classList.remove('disliked');
	        _this.setState({ hit_dislike: !hit_dislike });
	      }
	      if (hit_like) {
	        _this.setState({ likes_number: likes_number - 1 });
	        document.getElementById('like-button').classList.remove('liked');
	      } else {
	        _this.setState({ likes_number: likes_number + 1 });
	        document.getElementById('like-button').classList.add('liked');
	      }
	      _this.setState({ hit_like: !hit_like });
	    }, _this.dislike = function () {
	      var _this$state2 = _this.state,
	          hit_like = _this$state2.hit_like,
	          hit_dislike = _this$state2.hit_dislike,
	          likes_number = _this$state2.likes_number,
	          dislikes_number = _this$state2.dislikes_number;

	      if (hit_like && !hit_dislike) {
	        _this.setState({ likes_number: likes_number - 1 });
	        document.getElementById('like-button').classList.remove('liked');
	        _this.setState({ hit_like: !_this.state.hit_like });
	      }
	      if (hit_dislike) {
	        _this.setState({ dislikes_number: dislikes_number - 1 });
	        document.getElementById('dislike-button').classList.remove('disliked');
	  ...
	  _createClass(IntroCard, [{
	    ...
	    value: function render() {
	      ...
	      var _state = this.state,
	          likes_number = _state.likes_number,
	          dislikes_number = _state.dislikes_number;
